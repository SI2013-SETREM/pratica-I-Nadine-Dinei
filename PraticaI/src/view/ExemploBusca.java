 ...
 * @author Nadine
 */
public class ExemploBusca extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblPessoa, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSelecionaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaActionPerformed
        SlcPessoa p = new SlcPessoa(this, true);
        p.setVisible(true);
        pessoa = p.getPessoa();
        lblPessoa.setText(pessoa.getPesNome());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExemploBusca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExemploBusca().setVisible(true);
            }
        });
    }
